...
function buildPlantTab(S)
    ...
    S.plantInfo = uicontrol(p, 'Style', 'edit', 'MaxLines', 22, ...
...
function buildCtrlTab(S)
    ...
    S.ctrlInfo = uicontrol(p, 'Style', 'edit', 'MaxLines', 20, ...
        'HorizontalAlignment', 'left', 'Enable', 'inactive', ...
...
function buildScenTab(S)
    ...
    S.scList = uicontrol(p, 'Style', 'edit', 'MaxLines', 22, ...
        'HorizontalAlignment', 'left', 'Enable', 'inactive', ...
...
function buildRunTab(S)
    ...
    S.runInfo = uicontrol(p, 'Style', 'edit', 'MaxLines', 28, ...
        'HorizontalAlignment', 'left', 'Enable', 'inactive', ...
...
function buildExportTab(S)
    ...
    S.expInfo = uicontrol(p, 'Style', 'edit', 'MaxLines', 24, ...
        'HorizontalAlignment', 'left', 'Enable', 'inactive', ...
